    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-md overflow-y-auto">
        <motion.div
          ...
          className="glass-panel rounded-3xl p-6 sm:p-8 max-w-6xl w-full relative border border-amber-500/30 shadow-2xl my-auto bg-forest-950/90 text-white max-h-[90vh] overflow-y-auto"
        >
          {/* Close button */}
          <button
            onClick={onClose}
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-xs text-amber-400 font-medium">
                Server-Authoritative Progression & Companion Controls
              </p>
            </div>
          </div>
